...
//API Key
mapboxgl.accessToken = 'pk.eyJ1Ijoia2FuZ3dvb2MiLCJhIjoiY2phbXJtNjk0MzdtdjMzbWhhZHoydWRnMiJ9.SgqghxdkrocPrVWnt4Zf9w';
...
map.addControl(new mapboxgl.GeolocateControl({positionOptions:{enableHighAccuracy: true, timeout:30000}}));
...
function onCurrentPos(position) {
    ...
    let marker = mapboxgl.Marker(div).setLngLat(lnglat).addTo(map);
